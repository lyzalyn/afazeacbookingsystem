<%-- 
    ...
    Created on : 22 Jan 2024, 11:45:40 pm
...
<html lang="en">
    ...
    <body>
        ...
        <div class="w3-panel w3-card-4" style="display: flex; align-items: center; border-radius: 20px;">
            ...
            <a style="margin-left: 200px; padding-left: 150px; padding-right: 150px;" class="btn" href="<%=request.getContextPath()%>/newPackage">
                <ion-icon name="add-circle-outline"></ion-icon> Add New Package</a>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="packages" items="${listofPackage}">
                <tr>
                    <td><c:out value="${packages.packagesId}"/></td>
                <td><c:out value="${packages.packageName}"/></td>
               
                <td><a href="editPackage?packagesId=<c:out value='${packages.packagesId}' />">Edit</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="deletePackage?packagesId=<c:out value='${packages.packagesId}' />">Delete</a>
                </td>
                </tr>
            </c:forEach>
        </tbody>
        ...
        <div class="w3-panel w3-card-4" style="display: flex; align-items: center; border-radius: 20px;">
            <a href="<%=request.getContextPath()%>/listTreatment"> Treatment</a>
            <h4 style="color: #ff9999;  margin-right: 10px;" ><b>List</b></h4>
            ...
            <table class="table table-bordered" href="<%=request.getContextPath()%>/listPackage">
            <thead>
                <tr>
                    <th>Treatment ID</th>
